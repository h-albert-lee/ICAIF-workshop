...
L and I describe the basis for inclusion, not a universal ranking of sensitivity. All systems are scored against the same 36-category Korean benchmark definition and both tiers; prompted models receive that definition, while baseline labels use a fixed mapping. Masking policies are separate metadata. Thus device/IP remains a Tier I target regardless of a model's default privacy judgments. We compare L-identifier, L-attribute and I-attribute performance separately. A missed span alone does not establish a model's legal or cultural beliefs.
