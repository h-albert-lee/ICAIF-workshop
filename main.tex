...
\newcommand{\kiii}{\textsc{Kiii}$^{2}$}
%% Title spells the name "Kiii-Kiii" (after the girl group); body text uses \kiii (= Kiii^2) for the dataset.
\title[Kiii-Kiii: Korean Identifiers, Identifiability, and Ill-formed Inputs]{Kiii-Kiii: Korean Identifiers, Identifiability, and Ill-formed Inputs\\ \large A Regulation-Grounded Benchmark for Financial PII Detection}
